...
// GetCustomers method retuns Customer Array 
...
// the UPdateCustomer method prepares the Update statement by passing 
// the CustomerName and SSN from the customer object; this is shown in 
// the following code 
...
func UpdateCustomer(customer Customer){
	...
	var error error 
	var update *sql.Stmt 
	update, error = database.Prepare("UPDATE CUSTOMER SET CustomerName=? WHERE CustomerId=?") 
	if error != nil{
		panic(error.Error())
	}
